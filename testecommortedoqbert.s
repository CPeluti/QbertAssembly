...
.include "mensagemdemorteqbertembmp.data"
...
.text
	...
	la s0,MATRIZ 								#matriz de movimentacao
	la s1,MATRIZ_POSICOES							#matriz dos enderecos do bitmap
...
MAIN:	
	...
	FIM_LACO_PRINT:	mv s4,s2
			j MAIN
			
	FIM_JOGO: 	la a4, mensagemdemorteqbertembmp
			li t0, 0xFF000000
			add a1,zero,t0
			call imprimeCoisas
			ecall
...
LE_TECLA:
	...
	### Apenas verifica se tem tecla pressionada
...
PROCESSA_TECLA:
						#s0 = enderco pra vetor zerado MATRIZ
						#s1 = endereco pro vetor de posicoes MATRIZ_POSICOES
						#s2 = posicao do qbert
						#s3 = flag de morte
						#a1 = s0
	lw t0,TECLA_w
